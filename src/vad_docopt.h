...
"   --TRAMES_VEU_NO_DECIDIDES=INT         Numero de trames de veu no decidides [default: 1]\n"
"   --TRAMES_SILENCI_NO_DECIDIDES=INT     Numero de trames de silenci no decidides [default: 11]\n"
